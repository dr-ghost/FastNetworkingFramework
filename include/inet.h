...
int inet_getpeername(struct socket *sock, struct sockaddr *address, socklen_t *address_len);
int inet_getsockname(struct socket *sock, struct sockaddr *address, socklen_t *address_len);
